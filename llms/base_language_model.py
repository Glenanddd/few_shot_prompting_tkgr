...
class BaseLanguageModel(object):
    ...
    def generate_sentence(self, llm_input, return_usage=False):
        ...
        Args:
            ...
            return_usage (bool): when True, implementations should return a tuple
                of (text, usage_dict) where usage_dict contains token/time/cost
                metadata. Defaults to False to keep existing behaviour.
        """
        raise NotImplementedError
