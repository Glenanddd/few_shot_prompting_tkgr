...
class Grapher(object):
    def __init__(self, dataset_dir, args=None, test_mask=None):
        ...
        self.entity2id = load_json_data(maybe_windows_long_path(os.path.join(self.dataset_dir, "entity2id.json")))
        self.relation2id_old = load_json_data(maybe_windows_long_path(os.path.join(self.dataset_dir, "relation2id.json")))
        ...
        for relation in self.relation2id_old:
            ...
            counter += 1
        self.ts2id = load_json_data(maybe_windows_long_path(os.path.join(self.dataset_dir, "ts2id.json")))
    ...
    def create_store(self, file):
        ...
        with open(maybe_windows_long_path(os.path.join(self.dataset_dir, file)), "r", encoding="utf-8") as f:
            quads = f.readlines()
